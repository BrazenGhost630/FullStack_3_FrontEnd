...
export const CHILE_REGIONS: ChileRegion[] = [
  ...
  },
  {
    ...
    comunas: [
      ...
      { name: 'Quilpué', latitude: -33.0474, lng: -71.6887 },
      { name: 'Villa Alemana', latitude: -33.0333, lng: -71.6333 },
      { name: 'Limache', latitude: -32.9833, lng: -71.2500 },
      { name: 'Olmué', latitude: -32.9833, lng: -71.1667 },
      { name: 'La Calera', latitude: -32.7833, lng: -71.2000 },
      { name: 'Hijuelas', latitude: -32.8167, lng: -71.1167 },
      { name: 'La Cruz', latitude: -32.8333, lng: -71.2500 },
      { name: 'Nogales', latitude: -32.8000, lng: -71.2167 },
      { name: 'Quillota', latitude: -32.8833, lng: -71.2333 },
      { name: 'San Antonio', latitude: -33.5929, lng: -71.6077 },
      { name: 'San Pedro', latitude: -33.5500, lng: -71.6167 },
      { name: 'Cartagena', latitude: -33.6667, lng: -71.6000 },
      { name: 'El Tabo', latitude: -33.4500, lng: -71.6333 },
      { name: 'El Quisco', latitude: -33.4167, lng: -71.6833 },
      { name: 'Santo Domingo', latitude: -33.6500, lng: -71.6500 },
      { name: 'Los Andes', latitude: -32.8333, lng: -70.6000 },
      { name: 'Rinconada', latitude: -32.8500, lng: -70.6833 },
      { name: 'San Esteban', latitude: -32.8167, lng: -70.6500 },
      { name: 'Calle Larga', latitude: -32.9000, lng: -70.5333 },
      { name: 'Catemu', latitude: -32.7500, lng: -70.9167 },
      { name: 'Llay-Llay', latitude: -32.8333, lng: -70.9500 },
      { name: 'Panquehue', latitude: -32.7833, lng: -71.0833 },
      { name: 'Putaendo', latitude: -32.7000, lng: -70.7333 },
      { name: 'Santa María', latitude: -32.8833, lng: -70.9000 },
      { name: 'Cabildo', latitude: -32.9667, lng: -70.9500 },
      { name: 'La Ligua', latitude: -32.4500, lng: -71.1667 },
      { name: 'Papudo', latitude: -32.4667, lng: -71.4333 },
      { name: 'Petorca', latitude: -32.2333, lng: -70.8500 },
      { name: 'Zapallar', latitude: -32.5500, lng: -71.4500 },
      { name: 'Puchuncaví', latitude: -32.7333, lng: -71.4167 },
      { name: 'Quintero', latitude: -32.7833, lng: -71.5167 },
      { name: 'Isla de Pascua', latitude: -27.1167, lng: -109.3500 },
      { name: 'Juan Fernández', latitude: -33.6333, lng: -78.8500 },
      { name: 'Puchuncaví', latitude: -32.7333, lng: -71.4167 },
      { name: 'Quintero', latitude: -32.7833, lng: -71.5167 },
      { name: 'Casablanca', latitude: -33.4000, lng: -71.6167 },
      { name: 'Concón', latitude: -32.9500, lng: -71.5500 }
    ]
  },
  {
